...
![Version: 14.3.1](https://img.shields.io/badge/Version-14.3.1-informational?style=flat-square) ![AppVersion: 16.2.0](https://img.shields.io/badge/AppVersion-16.2.0-informational?style=flat-square)
...
| backup.cronjob.containerSecurityContext.seLinuxOptions | string | `nil` |  |
...
| image.tag | string | `"16.2.0-debian-12-r6"` |  |
| kubeVersion | string | `""` |  |
| ldap.basedn | string | `""` |  |
| ldap.binddn | string | `""` |  |
| ldap.bindpw | string | `""` |  |
...
| primary.containerSecurityContext.seLinuxOptions | string | `nil` |  |
...
| primary.resourcesPreset | string | `"none"` |  |
...
| readReplicas.containerSecurityContext.seLinuxOptions | string | `nil` |  |
...
| readReplicas.resourcesPreset | string | `"none"` |  |
