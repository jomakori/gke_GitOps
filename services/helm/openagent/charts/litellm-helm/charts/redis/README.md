...
![Version: 18.19.1](https://img.shields.io/badge/Version-18.19.1-informational?style=flat-square) ![AppVersion: 7.2.4](https://img.shields.io/badge/AppVersion-7.2.4-informational?style=flat-square)
...
| image.tag | string | `"7.2.4-debian-12-r9"` |  |
| kubeVersion | string | `""` |  |
...
| master.containerSecurityContext.seLinuxOptions | string | `nil` |  |
...
| master.resourcesPreset | string | `"none"` |  |
...
| metrics.containerSecurityContext.seLinuxOptions | string | `nil` |  |
...
| metrics.image.tag | string | `"1.58.0-debian-12-r4"` |  |
...
| replica.containerSecurityContext.seLinuxOptions | string | `nil` |  |
...
| replica.resourcesPreset | string | `"none"` |  |
...
| sentinel.containerSecurityContext.seLinuxOptions | string | `nil` |  |
...
| sentinel.image.tag | string | `"7.2.4-debian-12-r7"` |  |
...
| sentinel.resourcesPreset | string | `"none"` |  |
...
| sysctl.image.tag | string | `"12-debian-12-r16"` |  |
| sysctl.mountHostSys | bool | `false` |  |
| sysctl.resources | object | `{}` |  |
| sysctl.resourcesPreset | string | `"none"` |  |
