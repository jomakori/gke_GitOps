...
| hermes-agent.extraVolumeMounts[6].mountPath | string | `"/opt/hermes/.venv/lib/python3.13/site-packages/dashboard-fix.pth"` |  |
| hermes-agent.extraVolumeMounts[6].name | string | `"dashboard-auth-fix"` |  |
| hermes-agent.extraVolumeMounts[6].readOnly | bool | `true` |  |
| hermes-agent.extraVolumeMounts[6].subPath | string | `"dashboard-fix.pth"` |  |
| hermes-agent.extraVolumeMounts[7].mountPath | string | `"/opt/hermes/.venv/lib/python3.13/site-packages/dashboard_auth_fix.py"` |  |
| hermes-agent.extraVolumeMounts[7].name | string | `"dashboard-auth-fix"` |  |
| hermes-agent.extraVolumeMounts[7].readOnly | bool | `true` |  |
| hermes-agent.extraVolumeMounts[7].subPath | string | `"dashboard_auth_fix.py"` |  |
...
| hermes-agent.extraVolumes[5].configMap.name | string | `"openagent-dashboard-auth-fix"` |  |
| hermes-agent.extraVolumes[5].name | string | `"dashboard-auth-fix"` |  |
...
| litellm.proxy_config.fallbacks[6].deepseek-v4-flash[1] | string | `"opencode/nemotron-3-ultra-free"` |  |
...
| litellm.proxy_config.fallbacks[9]."zai/glm-4.7-flash"[1] | string | `"opencode/nemotron-3-ultra-free"` |  |
