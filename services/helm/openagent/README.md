...
| hermes-agent.extraEnv[10].name | string | `"DASHBOARD_BASE_URL"` |  |
...
| hermes-agent.extraEnv[6].value | string | `"true"` |  |
| hermes-agent.extraEnv[7].name | string | `"API_SERVER_KEY"` |  |
| hermes-agent.extraEnv[7].value | string | `"hermes-api-server-key-1234"` |  |
| hermes-agent.extraEnv[8].name | string | `"API_SERVER_HOST"` |  |
| hermes-agent.extraEnv[8].value | string | `"0.0.0.0"` |  |
| hermes-agent.extraEnv[9].name | string | `"API_SERVER_PORT"` |  |
| hermes-agent.extraEnv[9].value | string | `"8642"` |  |
