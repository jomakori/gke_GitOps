...
| oci://ghcr.io/jyje/hermes-agent-helm | hermes-agent | 1.2.0 |
...
| litellm.proxy_config.model_list[13].litellm_params.model | string | `"openai/claude-sonnet-5"` |  |
...
| litellm.proxy_config.model_list[14].litellm_params.model | string | `"openai/claude-sonnet-5"` |  |
...
| litellm.proxy_config.model_list[4].litellm_params.api_base | string | `"http://192.168.1.64:8317/v1"` |  |
| litellm.proxy_config.model_list[4].litellm_params.api_key | string | `"sk-auth2api-claude-proxy-key"` |  |
| litellm.proxy_config.model_list[4].litellm_params.model | string | `"openai/claude-opus-4-7"` |  |
| litellm.proxy_config.model_list[4].litellm_params.order | int | `1` |  |
| litellm.proxy_config.model_list[4].litellm_params.rpm | int | `10` |  |
