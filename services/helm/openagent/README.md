...
| hermes-agent.config.mcp_servers.kubectl.tools.include[0] | string | `"pods_get"` |  |
| hermes-agent.config.mcp_servers.kubectl.tools.include[10] | string | `"resources_delete"` |  |
| hermes-agent.config.mcp_servers.kubectl.tools.include[11] | string | `"resources_scale"` |  |
| hermes-agent.config.mcp_servers.kubectl.tools.include[12] | string | `"events_list"` |  |
| hermes-agent.config.mcp_servers.kubectl.tools.include[13] | string | `"namespaces_list"` |  |
| hermes-agent.config.mcp_servers.kubectl.tools.include[14] | string | `"configuration_view"` |  |
| hermes-agent.config.mcp_servers.kubectl.tools.include[1] | string | `"pods_list"` |  |
| hermes-agent.config.mcp_servers.kubectl.tools.include[2] | string | `"pods_list_in_namespace"` |  |
| hermes-agent.config.mcp_servers.kubectl.tools.include[3] | string | `"pods_log"` |  |
| hermes-agent.config.mcp_servers.kubectl.tools.include[4] | string | `"pods_exec"` |  |
| hermes-agent.config.mcp_servers.kubectl.tools.include[5] | string | `"pods_delete"` |  |
| hermes-agent.config.mcp_servers.kubectl.tools.include[6] | string | `"pods_top"` |  |
| hermes-agent.config.mcp_servers.kubectl.tools.include[7] | string | `"resources_get"` |  |
| hermes-agent.config.mcp_servers.kubectl.tools.include[8] | string | `"resources_list"` |  |
| hermes-agent.config.mcp_servers.kubectl.tools.include[9] | string | `"resources_create_or_update"` |  |
