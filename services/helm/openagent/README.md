...
| hermes-agent.extraVolumeMounts[5].mountPath | string | `"/mise"` |  |
| hermes-agent.extraVolumeMounts[5].name | string | `"hermes-mise-config"` |  |
...
| hermes-agent.extraVolumes[4].configMap.name | string | `"openagent-hermes-mise-config"` |  |
| hermes-agent.extraVolumes[4].name | string | `"hermes-mise-config"` |  |
...
| litellm.proxy_config.fallbacks[10]."minimax/M2.7"[0] | string | `"deepseek-v4-flash"` |  |
| litellm.proxy_config.fallbacks[10]."minimax/M2.7"[1] | string | `"zai/glm-4.7-flash"` |  |
| litellm.proxy_config.fallbacks[11].claude/sonnet-5[0] | string | `"deepseek-v4-pro"` |  |
| litellm.proxy_config.fallbacks[11].claude/sonnet-5[1] | string | `"zai/glm-4.7"` |  |
| litellm.proxy_config.fallbacks[12].claude/opus-4[0] | string | `"claude/sonnet-5"` |  |
| litellm.proxy_config.fallbacks[12].claude/opus-4[1] | string | `"deepseek-v4-pro"` |  |
| litellm.proxy_config.fallbacks[13].claude/opus-5[0] | string | `"claude/sonnet-5"` |  |
| litellm.proxy_config.fallbacks[13].claude/opus-5[1] | string | `"deepseek-v4-pro"` |  |
| litellm.proxy_config.fallbacks[1].opencode/deepseek-v4-flash-free[0] | string | `"deepseek-v4-flash"` |  |
| litellm.proxy_config.fallbacks[2]."opencode/mimo-v2.5-free"[0] | string | `"deepseek-v4-flash"` |  |
| litellm.proxy_config.fallbacks[3].anthropic/claude-opus-4-7[0] | string | `"claude/opus-4"` |  |
| litellm.proxy_config.fallbacks[3].anthropic/claude-opus-4-7[1] | string | `"deepseek-v4-pro"` |  |
| litellm.proxy_config.fallbacks[4]."moonshotai/kimi-k2.6"[0] | string | `"deepseek-v4-pro"` |  |
| litellm.proxy_config.fallbacks[4]."moonshotai/kimi-k2.6"[1] | string | `"zai/glm-4.7"` |  |
| litellm.proxy_config.fallbacks[5].deepseek-v4-flash[0] | string | `"zai/glm-4.7-flash"` |  |
| litellm.proxy_config.fallbacks[5].deepseek-v4-flash[1] | string | `"opencode/deepseek-v4-flash-free"` |  |
| litellm.proxy_config.fallbacks[6].deepseek-v4-pro[0] | string | `"zai/glm-4.7"` |  |
| litellm.proxy_config.fallbacks[6].deepseek-v4-pro[1] | string | `"deepseek-v4-flash"` |  |
| litellm.proxy_config.fallbacks[7]."zai/glm-4.7"[0] | string | `"deepseek-v4-pro"` |  |
| litellm.proxy_config.fallbacks[7]."zai/glm-4.7"[1] | string | `"zai/glm-4.7-flash"` |  |
| litellm.proxy_config.fallbacks[8]."zai/glm-4.7-flash"[0] | string | `"deepseek-v4-flash"` |  |
| litellm.proxy_config.fallbacks[8]."zai/glm-4.7-flash"[1] | string | `"opencode/deepseek-v4-flash-free"` |  |
| litellm.proxy_config.fallbacks[9].minimax/M3[0] | string | `"deepseek-v4-pro"` |  |
| litellm.proxy_config.fallbacks[9].minimax/M3[1] | string | `"zai/glm-4.7"` |  |
...
| litellm.proxy_config.model_list[10].litellm_params.model | string | `"openai/MiniMax-M2.7"` |  |
| litellm.proxy_config.model_list[10].litellm_params.order | int | `1` |  |
| litellm.proxy_config.model_list[10].model_name | string | `"minimax/M2.7"` |  |
| litellm.proxy_config.model_list[11].litellm_params.api_base | string | `"http://claude-proxy.openagent.svc.cluster.local:4523/v1"` |  |
| litellm.proxy_config.model_list[11].litellm_params.api_key | string | `"sk-auth2api-claude-proxy-key"` |  |
| litellm.proxy_config.model_list[11].litellm_params.model | string | `"openai/claude-sonnet-4-6"` |  |
| litellm.proxy_config.model_list[11].litellm_params.order | int | `1` |  |
| litellm.proxy_config.model_list[11].litellm_params.rpm | int | `120` |  |
| litellm.proxy_config.model_list[11].model_name | string | `"claude/sonnet-5"` |  |
...
| litellm.proxy_config.model_list[12].litellm_params.model | string | `"openai/claude-opus-4-7"` |  |
...
| litellm.proxy_config.model_list[12].model_name | string | `"claude/opus-4"` |  |
...
| litellm.proxy_config.model_list[13].litellm_params.model | string | `"openai/claude-opus-5"` |  |
...
| litellm.proxy_config.model_list[13].model_name | string | `"claude/opus-5"` |  |
...
| litellm.proxy_config.model_list[14].litellm_params.model | string | `"openai/claude-haiku-4-5"` |  |
| litellm.proxy_config.model_list[14].litellm_params.order | int | `1` |  |
| litellm.proxy_config.model_list[14].litellm_params.rpm | int | `60` |  |
| litellm.proxy_config.model_list[14].model_name | string | `"claude/haiku-4-5"` |  |
...
| litellm.proxy_config.model_list[1].litellm_params.model | string | `"openai/deepseek-v4-flash-free"` |  |
...
| litellm.proxy_config.model_list[1].model_name | string | `"opencode/deepseek-v4-flash-free"` |  |
...
| litellm.proxy_config.model_list[2].litellm_params.model | string | `"openai/mimo-v2.5-free"` |  |
...
| litellm.proxy_config.model_list[2].model_name | string | `"opencode/mimo-v2.5-free"` |  |
| litellm.proxy_config.model_list[3].litellm_params.api_key | string | `"os.environ/ANTHROPIC_API_KEY"` |  |
| litellm.proxy_config.model_list[3].litellm_params.model | string | `"anthropic/claude-opus-4-7"` |  |
| litellm.proxy_config.model_list[3].litellm_params.order | int | `1` |  |
| litellm.proxy_config.model_list[3].model_name | string | `"anthropic/claude-opus-4-7"` |  |
| litellm.proxy_config.model_list[4].litellm_params.api_key | string | `"os.environ/MOONSHOT_API_KEY"` |  |
| litellm.proxy_config.model_list[4].litellm_params.model | string | `"moonshot/kimi-k2.6"` |  |
| litellm.proxy_config.model_list[4].litellm_params.order | int | `1` |  |
| litellm.proxy_config.model_list[4].model_name | string | `"moonshotai/kimi-k2.6"` |  |
...
| litellm.proxy_config.model_list[5].litellm_params.model | string | `"deepseek/deepseek-v4-flash"` |  |
...
| litellm.proxy_config.model_list[5].model_name | string | `"deepseek-v4-flash"` |  |
| litellm.proxy_config.model_list[6].litellm_params.api_key | string | `"os.environ/DEEPSEEK_API_KEY"` |  |
| litellm.proxy_config.model_list[6].litellm_params.cache | bool | `true` |  |
| litellm.proxy_config.model_list[6].litellm_params.model | string | `"deepseek/deepseek-v4-pro"` |  |
...
| litellm.proxy_config.model_list[6].model_name | string | `"deepseek-v4-pro"` |  |
| litellm.proxy_config.model_list[7].litellm_params.api_key | string | `"os.environ/ZAI_API_KEY"` |  |
| litellm.proxy_config.model_list[7].litellm_params.model | string | `"zai/glm-4.7"` |  |
...
| litellm.proxy_config.model_list[7].model_name | string | `"zai/glm-4.7"` |  |
| litellm.proxy_config.model_list[8].litellm_params.api_key | string | `"os.environ/ZAI_API_KEY"` |  |
| litellm.proxy_config.model_list[8].litellm_params.model | string | `"zai/glm-4.7-flash"` |  |
...
| litellm.proxy_config.model_list[8].model_name | string | `"zai/glm-4.7-flash"` |  |
| litellm.proxy_config.model_list[9].litellm_params.api_base | string | `"os.environ/MINIMAX_API_BASE"` |  |
| litellm.proxy_config.model_list[9].litellm_params.api_key | string | `"os.environ/MINIMAX_API_KEY"` |  |
| litellm.proxy_config.model_list[9].litellm_params.model | string | `"openai/MiniMax-M3"` |  |
| litellm.proxy_config.model_list[9].litellm_params.order | int | `1` |  |
| litellm.proxy_config.model_list[9].model_name | string | `"minimax/M3"` |  |
