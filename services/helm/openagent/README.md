...
| hermes-agent.config.plugins.enabled[1] | string | `"opencode"` |  |
...
| hermes-agent.extraInitContainers[0].image | string | `"ghcr.io/jomakori/gitopsctl:bfeb99a86771d98b829636c974673169a485575b"` |  |
...
| hermes-agent.extraVolumeMounts[1].subPath | string | `"opencode.json"` |  |
| hermes-agent.extraVolumeMounts[2].mountPath | string | `"/opt/opencode/omo.jsonc"` |  |
| hermes-agent.extraVolumeMounts[2].name | string | `"opencode-config"` |  |
| hermes-agent.extraVolumeMounts[2].readOnly | bool | `true` |  |
| hermes-agent.extraVolumeMounts[2].subPath | string | `"omo.jsonc"` |  |
...
| litellm.proxy_config.model_list[18].litellm_params.model | string | `"openai/claude-opus-5"` |  |
...
| litellm.proxy_config.model_list[18].model_info.cache_read_input_token_cost | float | `5e-7` |  |
| litellm.proxy_config.model_list[18].model_info.input_cost_per_token | float | `0.000005` |  |
| litellm.proxy_config.model_list[18].model_info.output_cost_per_token | float | `0.000025` |  |
| litellm.proxy_config.model_list[18].model_name | string | `"claude-opus-5"` |  |
| litellm.proxy_config.model_list[19].litellm_params.api_base | string | `"http://claude-proxy.openagent.svc.cluster.local:4523/v1"` |  |
| litellm.proxy_config.model_list[19].litellm_params.api_key | string | `"os.environ/CLAUDE_PROXY_API_KEY"` |  |
| litellm.proxy_config.model_list[19].litellm_params.model | string | `"openai/claude-sonnet-4-6"` |  |
| litellm.proxy_config.model_list[19].litellm_params.order | int | `1` |  |
| litellm.proxy_config.model_list[19].litellm_params.rpm | int | `120` |  |
| litellm.proxy_config.model_list[19].model_info.cache_read_input_token_cost | float | `3e-7` |  |
| litellm.proxy_config.model_list[19].model_info.input_cost_per_token | float | `0.000003` |  |
| litellm.proxy_config.model_list[19].model_info.output_cost_per_token | float | `0.000015` |  |
...
| litellm.proxy_config.model_list[20].litellm_params.model | string | `"openai/claude-haiku-4-5"` |  |
| litellm.proxy_config.model_list[20].litellm_params.order | int | `1` |  |
| litellm.proxy_config.model_list[20].litellm_params.rpm | int | `60` |  |
| litellm.proxy_config.model_list[20].model_info.cache_read_input_token_cost | float | `1e-7` |  |
| litellm.proxy_config.model_list[20].model_info.input_cost_per_token | float | `0.000001` |  |
| litellm.proxy_config.model_list[20].model_info.output_cost_per_token | float | `0.000005` |  |
| litellm.proxy_config.model_list[20].model_name | string | `"claude-haiku-4-5"` |  |
...
| litellm.proxy_config.model_list[21].litellm_params.model | string | `"openai/byteplus-coding/bytedance-seed-code"` |  |
...
| litellm.proxy_config.model_list[21].model_name | string | `"bytedance-seed-code"` |  |
...
| litellm.proxy_config.model_list[22].litellm_params.model | string | `"openai/byteplus-coding/dola-seed-2.0-code"` |  |
| litellm.proxy_config.model_list[22].litellm_params.num_retries | int | `0` |  |
| litellm.proxy_config.model_list[22].litellm_params.order | int | `1` |  |
| litellm.proxy_config.model_list[22].litellm_params.rpm | int | `5` |  |
| litellm.proxy_config.model_list[22].model_name | string | `"bytedance-dola-seed-2.0-code"` |  |
| litellm.proxy_config.model_list[23].litellm_params.api_base | string | `"https://api.kilo.ai/api/gateway/v1"` |  |
| litellm.proxy_config.model_list[23].litellm_params.api_key | string | `"os.environ/KILO_API_KEY"` |  |
| litellm.proxy_config.model_list[23].litellm_params.merge_reasoning_content_in_choices | bool | `true` |  |
| litellm.proxy_config.model_list[23].litellm_params.model | string | `"openai/byteplus-coding/dola-seed-2.0-pro"` |  |
| litellm.proxy_config.model_list[23].litellm_params.num_retries | int | `0` |  |
| litellm.proxy_config.model_list[23].litellm_params.order | int | `1` |  |
| litellm.proxy_config.model_list[23].litellm_params.rpm | int | `5` |  |
| litellm.proxy_config.model_list[23].model_name | string | `"bytedance-dola-seed-2.0-pro"` |  |
| litellm.proxy_config.model_list[24].litellm_params.api_base | string | `"https://api.kilo.ai/api/gateway/v1"` |  |
| litellm.proxy_config.model_list[24].litellm_params.api_key | string | `"os.environ/KILO_API_KEY"` |  |
| litellm.proxy_config.model_list[24].litellm_params.merge_reasoning_content_in_choices | bool | `true` |  |
| litellm.proxy_config.model_list[24].litellm_params.model | string | `"openai/byteplus-coding/glm-5.2"` |  |
| litellm.proxy_config.model_list[24].litellm_params.num_retries | int | `0` |  |
| litellm.proxy_config.model_list[24].litellm_params.order | int | `1` |  |
| litellm.proxy_config.model_list[24].litellm_params.rpm | int | `5` |  |
| litellm.proxy_config.model_list[24].model_name | string | `"bytedance-glm-5.2"` |  |
| litellm.proxy_config.model_list[25].litellm_params.api_base | string | `"https://api.kilo.ai/api/gateway/v1"` |  |
| litellm.proxy_config.model_list[25].litellm_params.api_key | string | `"os.environ/KILO_API_KEY"` |  |
| litellm.proxy_config.model_list[25].litellm_params.merge_reasoning_content_in_choices | bool | `true` |  |
| litellm.proxy_config.model_list[25].litellm_params.model | string | `"openai/byteplus-coding/deepseek-v4-flash"` |  |
| litellm.proxy_config.model_list[25].litellm_params.num_retries | int | `0` |  |
| litellm.proxy_config.model_list[25].litellm_params.order | int | `1` |  |
| litellm.proxy_config.model_list[25].litellm_params.rpm | int | `5` |  |
| litellm.proxy_config.model_list[25].model_name | string | `"bytedance-deepseek-v4-flash"` |  |
...
| opencode.agents.atlas.models[0] | string | `"litellm/minimax-m3"` |  |
| opencode.agents.atlas.models[1] | string | `"litellm/deepseek-v4-pro"` |  |
| opencode.agents.atlas.models[2] | string | `"litellm/claude-sonnet-5"` |  |
| opencode.agents.atlas.models[3] | string | `"litellm/bytedance-dola-seed-2.0-pro"` |  |
| opencode.agents.explore.models[0] | string | `"litellm/deepseek-v4-flash"` |  |
| opencode.agents.explore.models[1] | string | `"litellm/minimax-m3"` |  |
| opencode.agents.explore.models[2] | string | `"litellm/claude-haiku-4-5"` |  |
| opencode.agents.explore.models[3] | string | `"litellm/bytedance-deepseek-v4-flash"` |  |
| opencode.agents.hephaestus.models[0] | string | `"litellm/minimax-m3"` |  |
| opencode.agents.hephaestus.models[1] | string | `"litellm/glm-5.3"` |  |
| opencode.agents.hephaestus.models[2] | string | `"litellm/claude-sonnet-5"` |  |
| opencode.agents.hephaestus.models[3] | string | `"litellm/bytedance-dola-seed-2.0-code"` |  |
| opencode.agents.librarian.models[0] | string | `"litellm/deepseek-v4-flash"` |  |
| opencode.agents.librarian.models[1] | string | `"litellm/minimax-m3"` |  |
| opencode.agents.librarian.models[2] | string | `"litellm/claude-haiku-4-5"` |  |
| opencode.agents.librarian.models[3] | string | `"litellm/bytedance-deepseek-v4-flash"` |  |
| opencode.agents.metis.models[0] | string | `"litellm/minimax-m3"` |  |
| opencode.agents.metis.models[1] | string | `"litellm/deepseek-v4-pro"` |  |
| opencode.agents.metis.models[2] | string | `"litellm/claude-sonnet-5"` |  |
| opencode.agents.metis.models[3] | string | `"litellm/bytedance-glm-5.2"` |  |
| opencode.agents.momus.models[0] | string | `"litellm/minimax-m3"` |  |
| opencode.agents.momus.models[1] | string | `"litellm/glm-5.3"` |  |
| opencode.agents.momus.models[2] | string | `"litellm/claude-sonnet-5"` |  |
| opencode.agents.momus.models[3] | string | `"litellm/bytedance-dola-seed-2.0-pro"` |  |
| opencode.agents.multimodal-looker.models[0] | string | `"litellm/gemini-3.6-flash"` |  |
| opencode.agents.multimodal-looker.models[1] | string | `"litellm/qwen3-6-plus"` |  |
| opencode.agents.multimodal-looker.models[2] | string | `"litellm/claude-sonnet-5"` |  |
| opencode.agents.multimodal-looker.models[3] | string | `"litellm/bytedance-seed-code"` |  |
| opencode.agents.oracle.models[0] | string | `"litellm/claude-opus-5"` |  |
| opencode.agents.oracle.models[1] | string | `"litellm/glm-5.3"` |  |
| opencode.agents.oracle.models[2] | string | `"litellm/bytedance-seed-code"` |  |
| opencode.agents.prometheus.models[0] | string | `"litellm/minimax-m3"` |  |
| opencode.agents.prometheus.models[1] | string | `"litellm/deepseek-v4-pro"` |  |
| opencode.agents.prometheus.models[2] | string | `"litellm/claude-sonnet-5"` |  |
| opencode.agents.prometheus.models[3] | string | `"litellm/bytedance-glm-5.2"` |  |
| opencode.agents.sisyphus-junior.models[0] | string | `"litellm/deepseek-v4-flash"` |  |
| opencode.agents.sisyphus-junior.models[1] | string | `"litellm/minimax-m3"` |  |
| opencode.agents.sisyphus-junior.models[2] | string | `"litellm/claude-haiku-4-5"` |  |
| opencode.agents.sisyphus-junior.models[3] | string | `"litellm/bytedance-deepseek-v4-flash"` |  |
| opencode.agents.sisyphus.models[0] | string | `"litellm/deepseek-v4-flash-direct"` |  |
| opencode.agents.sisyphus.models[1] | string | `"litellm/claude-sonnet-5"` |  |
| opencode.agents.sisyphus.models[2] | string | `"litellm/bytedance-glm-5.2"` |  |
| opencode.backgroundTask.defaultConcurrency | int | `8` |  |
| opencode.categories.deep.models[0] | string | `"litellm/minimax-m3"` |  |
| opencode.categories.deep.models[1] | string | `"litellm/glm-5.3"` |  |
| opencode.categories.deep.models[2] | string | `"litellm/claude-sonnet-5"` |  |
| opencode.categories.deep.models[3] | string | `"litellm/bytedance-dola-seed-2.0-pro"` |  |
| opencode.categories.default.models[0] | string | `"litellm/minimax-m3"` |  |
| opencode.categories.default.models[1] | string | `"litellm/glm-5.3"` |  |
| opencode.categories.default.models[2] | string | `"litellm/claude-sonnet-5"` |  |
| opencode.categories.default.models[3] | string | `"litellm/bytedance-glm-5.2"` |  |
| opencode.categories.quick.models[0] | string | `"litellm/deepseek-v4-flash"` |  |
| opencode.categories.quick.models[1] | string | `"litellm/minimax-m3"` |  |
| opencode.categories.quick.models[2] | string | `"litellm/claude-haiku-4-5"` |  |
| opencode.categories.ultrabrain.models[0] | string | `"litellm/claude-opus-5"` |  |
| opencode.categories.ultrabrain.models[1] | string | `"litellm/glm-5.3"` |  |
| opencode.categories.ultrabrain.models[2] | string | `"litellm/bytedance-seed-code"` |  |
| opencode.categories.visual-engineering.models[0] | string | `"litellm/gemini-3.6-flash"` |  |
| opencode.categories.visual-engineering.models[1] | string | `"litellm/qwen3-6-plus"` |  |
| opencode.categories.visual-engineering.models[2] | string | `"litellm/claude-sonnet-5"` |  |
| opencode.categories.writing.models[0] | string | `"litellm/minimax-m3"` |  |
| opencode.categories.writing.models[1] | string | `"litellm/claude-sonnet-5"` |  |
| opencode.defaultAgent | string | `"sisyphus"` |  |
| opencode.defaultModel | string | `"litellm/deepseek-v4-flash-direct"` |  |
| opencode.mcpToolAgents[0] | string | `"sisyphus"` |  |
| opencode.mcpToolAgents[1] | string | `"hephaestus"` |  |
| opencode.mcpToolAgents[2] | string | `"prometheus"` |  |
| opencode.mcpToolAgents[3] | string | `"atlas"` |  |
| opencode.plugin | string | `"oh-my-openagent@5.0.0-beta.48"` |  |
| opencode.runtimeFallback.cooldown_seconds | int | `30` |  |
| opencode.runtimeFallback.enabled | bool | `true` |  |
| opencode.runtimeFallback.max_fallback_attempts | int | `3` |  |
| opencode.runtimeFallback.notify_on_fallback | bool | `false` |  |
| opencode.runtimeFallback.restore_primary_after_cooldown | bool | `true` |  |
| opencode.runtimeFallback.retry_on_errors[0] | int | `400` |  |
| opencode.runtimeFallback.retry_on_errors[1] | int | `401` |  |
| opencode.runtimeFallback.retry_on_errors[2] | int | `403` |  |
| opencode.runtimeFallback.retry_on_errors[3] | int | `404` |  |
| opencode.runtimeFallback.retry_on_errors[4] | int | `429` |  |
| opencode.runtimeFallback.retry_on_errors[5] | int | `500` |  |
| opencode.runtimeFallback.retry_on_errors[6] | int | `502` |  |
| opencode.runtimeFallback.retry_on_errors[7] | int | `503` |  |
| opencode.runtimeFallback.retry_on_errors[8] | int | `504` |  |
| opencode.runtimeFallback.timeout_seconds | int | `30` |  |
...
| tools.image.tag | string | `"bfeb99a86771d98b829636c974673169a485575b"` |  |
...
| vpa.targets[1].containers[0].maxCpu | string | `"2"` |  |
| vpa.targets[1].containers[0].maxMemory | string | `"8Gi"` |  |
| vpa.targets[1].containers[0].minCpu | string | `"50m"` |  |
| vpa.targets[1].containers[0].minMemory | string | `"512Mi"` |  |
| vpa.targets[1].containers[0].name | string | `"opencode-server"` |  |
