...
| claude-proxy.enabled | bool | `true` |  |
| claude-proxy.image.pullPolicy | string | `"IfNotPresent"` |  |
| claude-proxy.image.repository | string | `"ghcr.io/jomakori/claude-proxy"` |  |
| claude-proxy.image.tag | string | `"latest"` |  |
| claude-proxy.persistence.enabled | bool | `true` |  |
| claude-proxy.persistence.size | string | `"100Mi"` |  |
| claude-proxy.persistence.storageClass | string | `"local-path"` |  |
| claude-proxy.resources.limits.cpu | string | `"1000m"` |  |
| claude-proxy.resources.limits.memory | string | `"1Gi"` |  |
| claude-proxy.resources.requests.cpu | string | `"100m"` |  |
| claude-proxy.resources.requests.memory | string | `"256Mi"` |  |
| claude-proxy.service.port | int | `4523` |  |
| hermes-webui.agentSource.enabled | bool | `true` |  |
| hermes-webui.agentSource.image | string | `"nousresearch/hermes-agent:v2026.7.7.2"` |  |
| hermes-webui.agentSource.sourcePath | string | `"/opt/hermes"` |  |
| hermes-webui.agentState.claimName | string | `"openagent-hermes-agent"` |  |
| hermes-webui.agentState.enabled | bool | `true` |  |
| hermes-webui.agentState.mountPath | string | `"/data/agent"` |  |
| hermes-webui.enabled | bool | `true` |  |
| hermes-webui.hermes.apiUrl | string | `"http://openagent-hermes-api.openagent.svc.cluster.local:8642"` |  |
| hermes-webui.image.pullPolicy | string | `"IfNotPresent"` |  |
| hermes-webui.image.repository | string | `"ghcr.io/nesquena/hermes-webui"` |  |
| hermes-webui.image.tag | string | `"latest"` |  |
| hermes-webui.persistence.enabled | bool | `true` |  |
| hermes-webui.persistence.size | string | `"2Gi"` |  |
| hermes-webui.persistence.storageClass | string | `"local-path"` |  |
| hermes-webui.publicUrl | string | `"https://openagent.maklab.net"` |  |
| hermes-webui.replicaCount | int | `1` |  |
| hermes-webui.resources.limits.cpu | string | `"1000m"` |  |
| hermes-webui.resources.limits.memory | string | `"1Gi"` |  |
| hermes-webui.resources.requests.cpu | string | `"100m"` |  |
| hermes-webui.resources.requests.memory | string | `"256Mi"` |  |
| hermes-webui.service.name | string | `"openagent-hermes-workspace"` |  |
| hermes-webui.service.port | int | `3000` |  |
| opencode-server.enabled | bool | `true` |  |
| opencode-server.envFromSecrets[0] | string | `"openagent-secrets"` |  |
| opencode-server.image.pullPolicy | string | `"IfNotPresent"` |  |
| opencode-server.image.repository | string | `"nousresearch/hermes-agent"` |  |
| opencode-server.image.tag | string | `"v2026.7.7.2"` |  |
| opencode-server.miseConfigMap | string | `"openagent-hermes-mise-config"` |  |
| opencode-server.nodeSelector | object | `{}` |  |
| opencode-server.opencodeConfigMap | string | `"openagent-opencode-config"` |  |
| opencode-server.persistence.claimName | string | `"openagent-hermes-agent"` |  |
| opencode-server.persistence.mountPath | string | `"/opt/data"` |  |
| opencode-server.resources.limits.cpu | string | `"2"` |  |
| opencode-server.resources.limits.memory | string | `"6Gi"` |  |
| opencode-server.resources.requests.cpu | string | `"2"` |  |
| opencode-server.resources.requests.memory | string | `"6Gi"` |  |
| opencode-server.service.port | int | `4096` |  |
