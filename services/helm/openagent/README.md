...
| hermes-agent.config.plugins.entries.omo.settings.mcp_enabled | bool | `true` |  |
...
| hermes-agent.config.plugins.entries.omo.settings.runtime_fallback.max_fallback_attempts | int | `3` |  |
...
| hermes-agent.config.plugins.entries.omo.settings.runtime_fallback.retry_on_errors[2] | int | `403` |  |
| hermes-agent.config.plugins.entries.omo.settings.runtime_fallback.retry_on_errors[3] | int | `404` |  |
| hermes-agent.config.plugins.entries.omo.settings.runtime_fallback.retry_on_errors[4] | int | `429` |  |
| hermes-agent.config.plugins.entries.omo.settings.runtime_fallback.retry_on_errors[5] | int | `500` |  |
| hermes-agent.config.plugins.entries.omo.settings.runtime_fallback.retry_on_errors[6] | int | `502` |  |
| hermes-agent.config.plugins.entries.omo.settings.runtime_fallback.retry_on_errors[7] | int | `503` |  |
| hermes-agent.config.plugins.entries.omo.settings.runtime_fallback.retry_on_errors[8] | int | `504` |  |
| hermes-agent.config.plugins.entries.omo.settings.runtime_fallback.retry_on_errors[9] | int | `529` |  |
