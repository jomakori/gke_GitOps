...
| hermes-agent.config.agent.api_max_retries | int | `1` |  |
| hermes-agent.config.agent.disabled_toolsets[0] | string | `"tts"` |  |
| hermes-agent.config.agent.disabled_toolsets[1] | string | `"vision"` |  |
...
| hermes-agent.config.delegation.fallback_providers[0].model | string | `"deepseek-v4-flash-direct"` |  |
...
| hermes-agent.config.file_read_max_chars | int | `40000` |  |
| hermes-agent.config.hooks.pre_tool_call[0].command | string | `"python3 /opt/data/hooks/read-guard/read_guard.py"` |  |
| hermes-agent.config.hooks.pre_tool_call[0].matcher | string | `"read_file"` |  |
| hermes-agent.config.hooks.pre_tool_call[0].timeout | int | `5` |  |
| hermes-agent.config.hooks_auto_accept | bool | `true` |  |
...
| hermes-agent.config.plugins.entries.omo.settings.categories.deep[2] | string | `"litellm/bytedance-dola-seed-2.0-pro"` |  |
| hermes-agent.config.plugins.entries.omo.settings.categories.deep[3] | string | `"litellm/claude-sonnet-5"` |  |
| hermes-agent.config.plugins.entries.omo.settings.categories.deep[4] | string | `"litellm/deepseek-v4-flash-direct"` |  |
| hermes-agent.config.plugins.entries.omo.settings.categories.quick[0] | string | `"litellm/deepseek-v4-flash-direct"` |  |
| hermes-agent.config.plugins.entries.omo.settings.categories.quick[1] | string | `"litellm/deepseek-v4-flash"` |  |
| hermes-agent.config.plugins.entries.omo.settings.categories.quick[2] | string | `"litellm/minimax-m3"` |  |
| hermes-agent.config.plugins.entries.omo.settings.categories.quick[3] | string | `"litellm/claude-haiku-4-5"` |  |
...
| hermes-agent.config.plugins.entries.omo.settings.chains.atlas[2] | string | `"litellm/bytedance-dola-seed-2.0-pro"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.atlas[3] | string | `"litellm/claude-sonnet-5"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.atlas[4] | string | `"litellm/deepseek-v4-flash-direct"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.explore[0] | string | `"litellm/deepseek-v4-flash-direct"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.explore[1] | string | `"litellm/deepseek-v4-flash"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.explore[2] | string | `"litellm/minimax-m3"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.explore[3] | string | `"litellm/claude-haiku-4-5"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.explore[4] | string | `"litellm/deepseek-v4-pro-direct"` |  |
...
| hermes-agent.config.plugins.entries.omo.settings.chains.hephaestus[2] | string | `"litellm/bytedance-glm-5.2"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.hephaestus[3] | string | `"litellm/claude-sonnet-5"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.hephaestus[4] | string | `"litellm/deepseek-v4-flash-direct"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.librarian[0] | string | `"litellm/deepseek-v4-flash-direct"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.librarian[1] | string | `"litellm/deepseek-v4-flash"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.librarian[2] | string | `"litellm/minimax-m3"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.librarian[3] | string | `"litellm/claude-haiku-4-5"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.librarian[4] | string | `"litellm/deepseek-v4-pro-direct"` |  |
...
| hermes-agent.config.plugins.entries.omo.settings.chains.metis[2] | string | `"litellm/bytedance-glm-5.2"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.metis[3] | string | `"litellm/claude-sonnet-5"` |  |
...
| hermes-agent.config.plugins.entries.omo.settings.chains.momus[2] | string | `"litellm/bytedance-dola-seed-2.0-pro"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.momus[3] | string | `"litellm/claude-sonnet-5"` |  |
...
| hermes-agent.config.plugins.entries.omo.settings.chains.multimodal-looker[2] | string | `"litellm/bytedance-seed-code"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.multimodal-looker[3] | string | `"litellm/claude-sonnet-5"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.multimodal-looker[4] | string | `"litellm/deepseek-v4-flash-direct"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.oracle[0] | string | `"litellm/glm-5.3"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.oracle[1] | string | `"litellm/bytedance-seed-code"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.oracle[2] | string | `"litellm/claude-opus-5"` |  |
...
| hermes-agent.config.plugins.entries.omo.settings.chains.prometheus[2] | string | `"litellm/bytedance-glm-5.2"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.prometheus[3] | string | `"litellm/claude-sonnet-5"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.prometheus[4] | string | `"litellm/deepseek-v4-flash-direct"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.sisyphus-junior[0] | string | `"litellm/deepseek-v4-flash-direct"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.sisyphus-junior[1] | string | `"litellm/deepseek-v4-flash"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.sisyphus-junior[2] | string | `"litellm/minimax-m3"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.sisyphus-junior[3] | string | `"litellm/claude-haiku-4-5"` |  |
| hermes-agent.config.plugins.entries.omo.settings.chains.sisyphus-junior[4] | string | `"litellm/deepseek-v4-pro-direct"` |  |
...
| hermes-agent.config.tool_output.max_lines | int | `500` |  |
...
| hermes-agent.extraVolumeMounts[1].mountPath | string | `"/opt/data/hooks/read-guard"` |  |
| hermes-agent.extraVolumeMounts[1].name | string | `"hermes-read-guard"` |  |
| hermes-agent.extraVolumeMounts[1].readOnly | bool | `true` |  |
| hermes-agent.extraVolumeMounts[2].mountPath | string | `"/opt/data/memories/k8s-gitops-context.md"` |  |
| hermes-agent.extraVolumeMounts[2].name | string | `"k8s-gitops-context"` |  |
| hermes-agent.extraVolumeMounts[2].readOnly | bool | `true` |  |
| hermes-agent.extraVolumeMounts[2].subPath | string | `"k8s-gitops-context.md"` |  |
| hermes-agent.extraVolumeMounts[3].mountPath | string | `"/mise"` |  |
| hermes-agent.extraVolumeMounts[3].name | string | `"hermes-mise-config"` |  |
| hermes-agent.extraVolumeMounts[3].readOnly | bool | `true` |  |
| hermes-agent.extraVolumeMounts[4].mountPath | string | `"/opt/tools"` |  |
| hermes-agent.extraVolumeMounts[4].name | string | `"tools"` |  |
| hermes-agent.extraVolumeMounts[4].readOnly | bool | `true` |  |
| hermes-agent.extraVolumeMounts[5].mountPath | string | `"/opt/data/mcp-verify"` |  |
| hermes-agent.extraVolumeMounts[5].name | string | `"mcp-verify"` |  |
...
| hermes-agent.extraVolumes[1].configMap.name | string | `"openagent-hermes-read-guard"` |  |
| hermes-agent.extraVolumes[1].name | string | `"hermes-read-guard"` |  |
