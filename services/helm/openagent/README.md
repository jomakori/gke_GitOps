...
| hermes-agent.config.delegation.model | string | `"glm-5.3"` |  |
...
| hermes-agent.config.model.default | string | `"glm-5.3"` |  |
...
| litellm.proxy_config.fallbacks[10].claude/sonnet-5[0] | string | `"glm-5.3"` |  |
| litellm.proxy_config.fallbacks[11].claude/opus-4[0] | string | `"claude/sonnet-5"` |  |
| litellm.proxy_config.fallbacks[12].claude/opus-5[0] | string | `"claude/sonnet-5"` |  |
| litellm.proxy_config.fallbacks[1].opencode/nemotron-3-ultra-free[0] | string | `"deepseek-v4-flash"` |  |
| litellm.proxy_config.fallbacks[2]."opencode/laguna-s-2.1-free"[0] | string | `"deepseek-v4-flash"` |  |
...
| litellm.proxy_config.fallbacks[5].deepseek-v4-flash[0] | string | `"glm-5.3"` |  |
| litellm.proxy_config.fallbacks[6].deepseek-v4-pro[0] | string | `"glm-5.3"` |  |
| litellm.proxy_config.fallbacks[7]."glm-5.3"[0] | string | `"deepseek-v4-pro"` |  |
| litellm.proxy_config.fallbacks[8].kimi-k3[0] | string | `"glm-5.3"` |  |
...
| litellm.proxy_config.model_list[10].litellm_params.model | string | `"openai/google/gemini-3.6-flash"` |  |
| litellm.proxy_config.model_list[10].litellm_params.order | int | `1` |  |
| litellm.proxy_config.model_list[10].model_name | string | `"gemini-3.6-flash"` |  |
...
| litellm.proxy_config.model_list[11].litellm_params.model | string | `"openai/qwen/qwen3.6-plus"` |  |
| litellm.proxy_config.model_list[11].litellm_params.order | int | `1` |  |
| litellm.proxy_config.model_list[11].model_name | string | `"qwen3-6-plus"` |  |
...
| litellm.proxy_config.model_list[8].litellm_params.model | string | `"openai/z-ai/glm-5.3"` |  |
| litellm.proxy_config.model_list[8].litellm_params.order | int | `1` |  |
| litellm.proxy_config.model_list[8].model_name | string | `"glm-5.3"` |  |
...
| litellm.proxy_config.model_list[9].litellm_params.model | string | `"openai/minimax/minimax-m3"` |  |
