...
| hermes-agent.config.plugins.entries.omo.settings.chains.explore[4] | string | `"litellm/bytedance-deepseek-v4-flash"` |  |
...
| hermes-agent.config.plugins.entries.omo.settings.chains.hephaestus[2] | string | `"litellm/bytedance-dola-seed-2.0-code"` |  |
...
| hermes-agent.config.plugins.entries.omo.settings.chains.librarian[4] | string | `"litellm/bytedance-deepseek-v4-flash"` |  |
...
| hermes-agent.config.plugins.entries.omo.settings.chains.sisyphus-junior[4] | string | `"litellm/bytedance-deepseek-v4-flash"` |  |
